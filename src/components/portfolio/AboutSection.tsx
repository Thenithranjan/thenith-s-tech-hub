...
const quickInfo = [
  { icon: MapPin, label: "Location", value: "Kallakurichi, Tamil Nadu" },
  { icon: Code, label: "Fields", value: "Full-Stack, Web Dev" },
  { icon: Users, label: "Interests", value: "Problem Solving, Tech" },
  { icon: Lightbulb, label: "Focus", value: "Innovation & Learning" },
];
